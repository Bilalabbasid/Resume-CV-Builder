...
export function ProfessionalTemplate({ resume }: { resume: Resume }) {
    ...
    return (
        <div className="bg-white text-gray-900 h-full min-h-[11in] font-serif p-10" id="resume-preview">
            {/* Classic Header */}
            ...
            {summary && (
                <section className="mb-5">
                    <h2 className="text-sm font-bold uppercase tracking-widest text-gray-900 mb-2">Professional Summary</h2>
